...
- 用户的最新明确指令优先级最高。
- 需求与 BUG 统一以 GitHub Issues 为准；用户文档位于 `docs/user/`，开发文档位于 `docs/development/`。
- Git 工作流与发布流程统一以 `docs/development/git-workflow.zh-CN.md` 与 `docs/development/RELEASING.zh-CN.md` 为准。
...
- 分支策略严格遵循 `docs/development/git-workflow.zh-CN.md`。
...
- 先读 Issues 与相关架构/开发文档，再编码；禁止未读上下文直接改代码。
